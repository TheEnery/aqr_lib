...
class FinderPatternFinder {
  ...
  FinderPatternInfo find() {
    ...
    return (
      bottomLeft: patternInfo[0],
      topLeft: patternInfo[1],
      topRight: patternInfo[2],
    );
  }
  ...
  bool _crossCheckDiagonal(int centerI, int centerJ) {
    ...
    while (centerI >= i &&
        centerJ >= i &&
        (_image[centerJ - i][centerI - i] & 1 == 1)) {
      stateCount[2]++;
      i++;
    }
    if (stateCount[2] == 0) {
  ...
  double _crossCheckVertical(
    ...
    while (
        i >= 0 && !(image[centerJ][i] & 1 == 1) && stateCount[1] <= maxCount) {
      stateCount[1]++;
      i--;
    }
    ...
    while (
        i >= 0 && (image[centerJ][i] & 1 == 1) && stateCount[0] <= maxCount) {
      stateCount[0]++;
      i--;
    }
    ...
    i = startI + 1;
    while (i < maxI && (image[centerJ][i] & 1 == 1)) {
      stateCount[2]++;
      i++;
    }
    if (i == maxI) {
    ...
    while (
        i < maxI && !(image[centerJ][i] & 1 == 1) && stateCount[3] < maxCount) {
      stateCount[3]++;
      i++;
    }
    ...
    while (
        i < maxI && (image[centerJ][i] & 1 == 1) && stateCount[4] < maxCount) {
      stateCount[4]++;
      i++;
    }
  ...
  double _crossCheckHorizontal(
    ...
    while (
        j >= 0 && !(image[j][centerI] & 1 == 1) && stateCount[1] <= maxCount) {
      stateCount[1]++;
      j--;
    }
    ...
    while (
        j >= 0 && (image[j][centerI] & 1 == 1) && stateCount[0] <= maxCount) {
      stateCount[0]++;
      j--;
    }
    if (stateCount[0] > maxCount) {
    ...
    j = startJ + 1;
    while (j < maxJ && (image[j][centerI] & 1 == 1)) {
      stateCount[2]++;
      j++;
    }
    if (j == maxJ) {
    ...
    while (
        j < maxJ && !(image[j][centerI] & 1 == 1) && stateCount[3] < maxCount) {
      stateCount[3]++;
      j++;
    }
    ...
    while (
        j < maxJ && (image[j][centerI] & 1 == 1) && stateCount[4] < maxCount) {
      stateCount[4]++;
      j++;
    }
    if (stateCount[4] >= maxCount) {
